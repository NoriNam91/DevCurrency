...
export function Detail() {
  ...
  useEffect(() => {
    function getData() {
      fetch(`https://sujeitoprogramador.com/api-cripto/coin/?key=7dc9235ac84b9710&symbol=${cripto}`)
        ...
        .then((data: CoinProp) => {     
          ...
          const resultData = {
            ...
            numberDelta24h: parseFloat(data.delta_24h.replace(",","."))
  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.content}>
        ...
        <p>
          <strong>Menos preço 24h:</strong> {detail?.formatedLowPrice}
        </p>
        <p>
          <strong>Delta 24h:</strong>
          <span className={detail?.numberDelta24h && detail?.numberDelta24h >= 0 ? styles.profit : styles.loss}>
            {detail?.delta_24h}
          </span>
        </p>
        <p>
